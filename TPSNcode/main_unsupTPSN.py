...
def train_net(unet,
    ...
    criterion_Lapl = LapLossFunc(weight, device)
...
def get_args():
    ...
    parser.add_argument('-l1', '--lambda1', dest='lambda1', type=float, default=10,
                        help='The weight of the Jacobian loss')
    parser.add_argument('-l2', '--lambda2', dest='lambda2', type=float, default=100,
